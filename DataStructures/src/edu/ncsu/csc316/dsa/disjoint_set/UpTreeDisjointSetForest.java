...
public class UpTreeDisjointSetForest<E> implements DisjointSetForest<E> {
	...
	/**
	 * A map of the element, and nodes corresponding to that element.
	 */
    ...
    private static class UpTreeNode<E> implements Position<E> {
        ...
        /**
         * The number of nodes in the tree. Only defined if node is a root node
         */
        private int count;
         ...
         * UpTreeNode
         * 
         * @param count the new count for the node
         */
